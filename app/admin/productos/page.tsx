              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50 transition-colors h-12">
                      {/* Nombre */}
                      ...
                      <td className="px-6 py-2">
                        {editingId === product.id ? (
                          <Input
                            ...
                            onChange={(e) => setEditingData({ ...editingData, stock_quantity: parseInt(e.target.value) })}
                            className="h-7 text-sm"
                          />
                        ) : (
                      ...
                      <td className="px-6 py-2">
                        {editingId === product.id ? (
                          <select
                            ...
                            className="h-7 text-sm border rounded"
                          >
              ...
              <CardContent className="p-4">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button type="submit" className="h-9 px-4 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
        ...
        <DialogContent className="max-w-md">
          <Card className="bg-white shadow-sm border-0">
            <CardHeader className="text-center border-b border-gray-100 pb-4">
              ...
              <p className="text-sm text-gray-600 mt-1">
                ¿Estás seguro que deseas eliminar <span className="font-semibold">{productToDelete?.name}</span>? Esta acción no se puede deshacer.
              </p>
            </CardHeader>
